...
project = 'tupan'
copyright = '2011-{}, Guilherme G. Ferrari'.format(time.strftime('%Y'))
...
latex_documents = [
  ('index', 'tupan.tex', 'tupan Documentation',
   'Guilherme G. Ferrari', 'manual'),
]
...
man_pages = [
    ('index', 'tupan', 'tupan Documentation',
     ['Guilherme G. Ferrari'], 1)
]
...
texinfo_documents = [
  ('index', 'tupan', 'tupan Documentation',
   'Guilherme G. Ferrari', 'tupan', 'One line description of project.',
   'Miscellaneous'),
]
