...
VEC4 get_acc( unsigned long iindex,
              double imass,
              double ieps2,
              double *ipos,
              double *ivel,
...
static PyObject *_get_acc(PyObject *_self, PyObject *_args)
{
...
/*    ieps2 = pcast_to_double(_ieps2);*/
    ...
    VEC4 acc = get_acc(iindex, imass, ieps2, ipos, ivel,
...
static PyMethodDef _gravity_meths[] = {
    {"get_acc", (PyCFunction)_get_acc, METH_VARARGS,
                "returns Newtonian acceleration."},
    {NULL, NULL, 0, NULL},
};


PyMODINIT_FUNC init_gravity(void)
{
    PyObject *ret;

    ret = Py_InitModule("_gravity", _gravity_meths);
